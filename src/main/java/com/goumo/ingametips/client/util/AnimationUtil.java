...
public class AnimationUtil {
    ...
    public static float calcProgress(int animationLength, String id, boolean loop) {
        ...
        float progress = animationList.get(id).getProgress(System.currentTimeMillis());
    ...
    public static long lastCalcDelta(String id) {
        return animationList.get(id) != null ? System.currentTimeMillis() - animationList.get(id).lastGet : 0;
    }
    ...
    private static void newAnimation(int animationLength, String id) {
        animationList.put(id, new AnimationElement(animationLength, System.currentTimeMillis()));
    }
}
